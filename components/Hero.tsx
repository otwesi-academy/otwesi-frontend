...
const Hero = () => {
    ...
    return (
        <section className="relative w-full min-h-[95vh] flex flex-col items-center justify-center overflow-hidden pb-16 pt-8 px-4 sm:px-6 lg:px-8">
            {/* Background Gradient */}
            <div className="absolute inset-0 bg-linear-to-br from-[#0b0f2c] via-[#101637] to-[#13204d]"></div>

            {/* Animated Floating Shapes */}
            <div className="absolute top-20 left-4 sm:left-20 w-20 sm:w-24 h-20 sm:h-24 bg-purple-400/20 rounded-xl blur-xl animate-[float_6s_ease-in-out_infinite]"></div>
            <div className="absolute bottom-16 right-4 sm:right-32 w-24 sm:w-32 h-24 sm:h-32 bg-indigo-500/20 rounded-full blur-2xl animate-[float2_8s_ease-in-out_infinite]"></div>

            {/* Hero Content */}
            <div className="relative z-20 w-full max-w-3xl text-center">
                <div className="backdrop-blur-md bg-black/20 p-6 sm:p-12 rounded-3xl border border-white/20 shadow-xl">
