...
export default function AdminBlogPostsPage() {
    ...
    const fetchBlogposts = async () => {
        try {
            ...
            console.error("Failed to fetch blogposts:", e);
        } finally {
    ...
    useEffect(() => {
        const filteredList = blogposts.filter((b) =>
            ...
            {formVisible && (
                ...
                >
                    <h2 className="text-xl font-semibold">
                        {editingSlug ? "Edit Blogpost" : "Add Blogpost"}
                    </h2>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {currentPosts.map((post) => (
                        ...
                        >
                            ...
                            <p className="text-gray-400 text-sm">{post.content.slice(0, 100)}...</p>
